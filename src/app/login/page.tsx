...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Force refresh to update server components (Navbar)
            router.refresh();
                ...
                <Card className="bg-zinc-900 border-zinc-800 text-white shadow-2xl shadow-red-900/10">
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="pin" className="text-zinc-200">PIN</Label>
                                <div className="relative">
                    ...
                    <CardFooter className="flex flex-col space-y-4 text-center">
                        <div className="text-sm text-zinc-400">
                            ...
                            <Link href="/signup" className="text-red-500 hover:text-red-400 font-semibold hover:underline">
                                Join Now
                            </Link>
                        </div>
                    </CardFooter>
